                ...
                <div className="flex flex-col lg:flex-row items-center gap-16">
                    ...
                    >
                        <div className="relative z-10 grid grid-cols-2 gap-3 md:gap-6">
                            <div className="bg-cream p-4 md:p-8 rounded-2xl shadow-md border-l-4 border-orange transform translate-y-6 md:translate-y-12">
                                <Users size={24} className="text-orange mb-4 md:size-10" />
                                <h3 className="text-2xl md:text-4xl font-bold text-primary mb-1">50+</h3>
                                <p className="text-primary/50 text-[10px] md:text-base leading-tight">Satisfied Clients</p>
                            </div>
                            <div className="bg-primary p-4 md:p-8 rounded-2xl shadow-md border-l-4 border-peach text-cream">
                                <Globe size={24} className="text-peach mb-4 md:size-10" />
                                <h3 className="text-2xl md:text-4xl font-bold mb-1">15+</h3>
                                <p className="text-cream/60 text-[10px] md:text-base leading-tight">Countries Served</p>
                            </div>
                            <div className="bg-orange p-4 md:p-8 rounded-2xl shadow-md border-l-4 border-cream text-white">
                                <Zap size={24} className="text-cream mb-4 md:size-10" />
                                <h3 className="text-2xl md:text-4xl font-bold mb-1">98%</h3>
                                <p className="text-white/80 text-[10px] md:text-base leading-tight">Project Success Rate</p>
                            </div>
                            <div className="bg-cream p-4 md:p-8 rounded-2xl shadow-md border-l-4 border-peach transform translate-y-6 md:translate-y-12">
                                <Award size={24} className="text-peach mb-4 md:size-10" />
                                <h3 className="text-2xl md:text-4xl font-bold text-primary mb-1">{yearsExperience}+</h3>
                                <p className="text-primary/50 text-[10px] md:text-base leading-tight">Years of Expertise</p>
                            </div>
                        </div>
